...
<h3> Что происходит, когда вы сидите? </h3>
...
<h3> Как ваше кресло может вам навредить </h3>
...
<h5> Изменяется осанка и страдает позвоночник </h5>
...
<div class="images" align="center" style="width:300px; height: 300px; margin: auto; position: relative; margin-bottom: 200px;">
    <div class="image_item">
        <img alt="Триггерные точки в мышцах" src="/trigger_point.jpeg" />
    </div>
</div>
...
<h5> Связь между здоровьем спины и настроением </h5>
...
<div class="images" align="center" style="width:550px; height: 550px; margin: auto; position: relative; margin-bottom: -100px;">
    <div class="image_item">
        <img alt="Нагрузка на шею при наклоне" src="/smartfon_spina.jpeg" />
    </div>
</div>
  
  
<h5> Сидя вы толстеете </h5>
...
<h5> Проблемы с кожей, ногтями и волосами </h5>
...
<h4> Что происходит, когда вы встаёте?  </h4>
...
<h4> Выход из ситуации Movement-Based Lifestyle  </h4>

* Прерывайте положение сидя, как можно чаще; (20, 21, 22)
  * Я использую технику Pomodoro, ставлю таймер на каждые 20-25 минут, после чего стараюсь сделать несколько отжиманий/приседаний, либо как минимум просто встать и сесть; 

* Звонки, совещания делайте «на ногах». Walk-and-talk;
...
* Используйте стол для работы стоя или даже лучше совместить вместе с беговой дорожкой;
  * Монитор на уровне глаз; Сделайте модификации для вашего ноутбука/ПК, купите отдельную клавиатуру, мышку и подставку; 

  * Вот пример моего самодельного рабочего места. Опробываю такой вариант уже неделю и субьективно энергии стало на 30% больше; До этого был просто «стол» без дорожки, но после долгой работы стоя начинали болеть икры. А на дорожке со скоросью ~1 км/час выходит, то что нужно.

<h5> Сколько шагов нужно делать в день? </h5>
...
<h5> Встаньте вовремя, что бы остаться здоровыми!   </h5>

      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (!(typeof ((_page$context = page.context) === null || _page$context === void 0 ? void 0 : _page$context.i18n) === 'object')) {
              _context3.next = 3;
              break;
            }
          ...
          case 3:
            ...
            generatePage = /*#__PURE__*/function () {
              var _ref4 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(_ref3) {
                var language, _ref3$path, path, _ref3$originalPath, originalPath, _ref3$routed, routed, _ref3$matchPath, matchPath, pageOptions;
                return _regenerator.default.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        language = _ref3.language, _ref3$path = _ref3.path, path = _ref3$path === void 0 ? page.path : _ref3$path, _ref3$originalPath = _ref3.originalPath, originalPath = _ref3$originalPath === void 0 ? page.path : _ref3$originalPath, _ref3$routed = _ref3.routed, routed = _ref3$routed === void 0 ? false : _ref3$routed, _ref3$matchPath = _ref3.matchPath, matchPath = _ref3$matchPath === void 0 ? page.matchPath : _ref3$matchPath, pageOptions = _ref3.pageOptions;
